...
***********************************************************************************************************************/
/***********************************************************************************************************************
* Touch I/F Configuration File  : g22_fpb.tifcfg
* Tuning Log File               : g22_fpb_log_tuning20230829153703.log
***********************************************************************************************************************/
...
{
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x111, .snum = 0x07, .sdpa = 0x03 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x148, .snum = 0x07, .sdpa = 0x03 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x147, .snum = 0x07, .sdpa = 0x03 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x129, .snum = 0x07, .sdpa = 0x03 },
    { .ssdiv = CTSU_SSDIV_4000, .so = 0x0FB, .snum = 0x07, .sdpa = 0x03 },
};
...
const ctsu_cfg_t g_qe_ctsu_cfg_config01 =
{
    ...
    .ctsuchac2  = 0xF0, /* ch16-ch23 enable mask */
    .ctsuchac3  = 0x01, /* ch24-ch31 enable mask */
